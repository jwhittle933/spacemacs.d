...
layers configuration. You are free to put any user code."
  ...
  (push
   #'(lambda (b) (or (eq 'org-agenda-mode (buffer-local-value 'major-mode b))
                     (and (member 'org-capture-mode (buffer-local-variables b))
